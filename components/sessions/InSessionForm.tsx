...
>(
  (
    ...
    const [formState, setFormState] = useState<InSessionFormState>({
      ...
      inTime: externalInTime || getCurrentDateTime(),
      grossWeightKg: null,
      carWeight: 0,
      trailerWeight: 0,
      totalWeight: 0,
    ...
    const performSave = async (): Promise<boolean> => {
      ...
      try {
        ...
        // Third-party sending is intentionally disabled for IN session.
        // Keep a single send flow in History/OUT to avoid duplicate payload writers.
