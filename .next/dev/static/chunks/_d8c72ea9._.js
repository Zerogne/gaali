...
function TruckSection({ direction, onSave, onSend }) {
    ...
    const handleSave = async ()=>{
        ...
        setIsSaving(true);
        try {
            const log = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveTruckLog"])({
                direction,
                plate: plate.trim(),
    ...
    const handleSend = async ()=>{
        ...
        setIsSending(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendTruckLogToCustoms"])(savedLogId);
            if (result.success) {
                onSend(savedLogId);
                toast({
                    title: "Success",
...
function TruckTable({ logs, onSend }) {
    ...
    const handleResend = async (log)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendTruckLogToCustoms"])(log.id);
            if (result.success) {
                onSend(log.id);
                toast({
                    title: "Success",
...
//# sourceMappingURL=_d8c72ea9._.js.map