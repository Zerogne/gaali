...
"[project]/lib/data:f78349 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/loader-circle.js [app-client] (ecmascript) <export default as Loader2>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$f78349__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:f78349 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$13e6ba__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:13e6ba [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-toast.ts [app-client] (ecmascript)");
...
function TruckSection({ direction, onSave, onSend }) {
    ...
    const handleSave = async ()=>{
        ...
        setIsSaving(true);
        try {
            const log = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$f78349__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveTruckLog"])({
                direction,
                plate: plate.trim(),
    ...
    const handleSend = async ()=>{
        ...
        setIsSending(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$13e6ba__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendTruckLogToCustoms"])(savedLogId);
            if (result.success) {
                onSend(savedLogId);
                toast({
                    title: "Success",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditLogDialog.useEffect": ()=>{
            if (log) {
                ...
                setVehicleRegistrationNumber(log.vehicleRegistrationNumber || "");
                setVehicleRegistrationYear(log.vehicleRegistrationYear || "");
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            ...
                                                            type: "number",
                                                            value: vehicleRegistrationYear,
                                                            onChange: (e)=>setVehicleRegistrationYear(e.target.value),
                                                            className: "mt-1 bg-white border-gray-300 focus:border-blue-500 focus:ring-blue-500",
                                                            placeholder: "Жил",
                                                            min: "1900",
                                                            max: new Date().getFullYear()
...
_s(EditLogDialog, "sKcH8Hf0Lg6UIYKZdK031XyjOhQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
function TruckTable({ logs, onSend, onUpdate }) {
    ...
    const handleResend = async (log)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$13e6ba__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendTruckLogToCustoms"])(log.id);
            if (result.success) {
                onSend(log.id);
                toast({
                    title: "Success",
...
"[project]/lib/data:af6851 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$af6851__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:af6851 [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
        ...
        "DashboardPage.useEffect": ()=>{
            ...
            async function loadLogs() {
                try {
                    ...
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$af6851__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getTruckLogs"])(1, 50);
                    setLogs(result.logs);
                } catch (error) {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$trucks$2f$TruckTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TruckTable"], {
                                    ...
                                    onUpdate: ()=>{
                                        ...
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$af6851__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getTruckLogs"])(1, 50).then(({ logs })=>setLogs(logs)).catch(console.error);
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/app/page.tsx",
                                    lineNumber: 129,
...
//# sourceMappingURL=_d677889e._.js.map