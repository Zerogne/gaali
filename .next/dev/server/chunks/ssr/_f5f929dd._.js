...
"[project]/lib/auth/data:5ec98b [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$data$3a$5ec98b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/auth/data:5ec98b [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
async function handleLogout() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$data$3a$5ec98b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["logout"])();
...
"[project]/lib/data:ba7e83 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:0d4c6c [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
function TruckSection({ direction, onSave, onSend }) {
    ...
    const handleSave = async ()=>{
        ...
        setIsSaving(true);
        try {
            const log = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$ba7e83__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveTruckLog"])({
                direction,
                plate: plate.trim(),
    ...
    const handleSend = async ()=>{
        ...
        setIsSending(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$0d4c6c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendTruckLogToCustoms"])(savedLogId);
            if (result.success) {
                onSend(savedLogId);
                toast({
                    title: "Success",
...
function TruckTable({ logs, onSend }) {
    ...
    const handleResend = async (log)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$0d4c6c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendTruckLogToCustoms"])(log.id);
            if (result.success) {
                onSend(log.id);
                toast({
                    title: "Success",
...
"[project]/lib/data:0e48ad [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$0e48ad__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:0e48ad [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function loadLogs() {
            try {
                setIsLoading(true);
                const companyLogs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$0e48ad__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getTruckLogs"])();
                setLogs(companyLogs);
            } catch (error) {
...
//# sourceMappingURL=_f5f929dd._.js.map