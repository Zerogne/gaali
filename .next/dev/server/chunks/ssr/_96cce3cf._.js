...
function TruckSection({ direction, onSave, onSend }) {
    ...
    const handleSend = async ()=>{
        ...
        setIsSending(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendTruckLogToCustoms"])(savedLogId);
            if (result.success) {
                onSend(savedLogId);
                toast({
                    title: "Success",
...
//# sourceMappingURL=_96cce3cf._.js.map