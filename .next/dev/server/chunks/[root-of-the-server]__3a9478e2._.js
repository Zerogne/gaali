...
async function proxy(request) {
    ...
    pathname.startsWith('/api/auth') || pathname.startsWith('/api/seed') || // Allow seed endpoint
    ...
    if (!companyId || !workerId) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/login', url));
    }
    ...
    if (expiresAt) {
        ...
        if (!isNaN(expires) && expires < Date.now()) {
            // Session expired
            const response = pathname.startsWith('/api/') ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Session expired'
            }, {
                status: 401
            }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/login', url));
    ...
    if (pathname.startsWith('/login') && companyId && workerId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/', url));
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
}
/**
