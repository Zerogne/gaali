...
"[project]/app/api/organizations/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const { _id, ...serialized } = updatedOrg;
...
async function DELETE(request, { params }) {
    try {
        ...
        const result = await orgsCollection.deleteOne({
            id
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__051ec30a._.js.map